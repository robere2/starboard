...
import {copyExtraFiles, createIndexFiles, logger, writeSchemaTypedefs} from "./tools.js";
import chalk from "chalk";

for(const schemaKey in Schemas) {
    logger(chalk.cyan(`Writing type definitions for ${chalk.cyanBright(schemaKey)}...`))
