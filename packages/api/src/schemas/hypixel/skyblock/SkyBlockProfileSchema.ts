...
import {ZodEnumHypixelSkyBlockDungeonClasses} from "../../enums";
...
export type HypixelSkyBlockProfile = z.infer<SkyBlockProfileSchema>["profile"];

function skyBlockProfile() {
...
export function generateSkyBlockProfileSchema() {
    return HypixelBaseSchema.extend({
        profile: skyBlockProfile()
    })
}

export function generateSkyBlockProfilesSchema() {
    return HypixelBaseSchema.extend({
        profiles: z.array(skyBlockProfile()).default([])
    })
}
